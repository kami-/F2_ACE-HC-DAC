...
DAC_Players = [];_i = 0;_u = objNull;_nObj = [];_PLUnit = objNull;_newUnit = objNull;_oldUnits = [];_sCount = 0;

{if(!(format["%1",call compile _x] == scalar)) then {DAC_Players = DAC_Players + [call compile _x]}} foreach DAC_STRPlayers;
