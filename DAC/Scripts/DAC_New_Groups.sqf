...
private [
			...
			"_DAC_Camp_Typ","_countrandom","_zonr","_zmod","_WPTempA","_WPTempB","_fwp","_m","_max","_action",
			"_HeloArray","_CenterSides","_ci","_chnr","_run","_go","_countmax","_countmin","_tz","_DAC_ExtraUnit",
			"_GroupVar","_TempArray","_ScriptArray","_GroupWP","_WPAll","_nr","_wp","_zc","_tw","_GroupPos","_h",
			"_gwp","_cwp","_Camp_Pool","_groupBehav","_DAC_Zone_Set","_DAC_This_Zone","_wpConfNr","_zData"
		];

			_DAC_Group_Typ = _this select 0;_TempArray = ["S","V","T","A","C"];_ScriptArray = [2,3,4,5];_zonr = 0;_h = 0;
			_DAC_SelectZone = [];_DAC_EnemyZone = objNull;
			_zmod = 0;_WPTempA = [];_WPArray = format["DAC_WP_Pool_%1",_TempArray select (_DAC_Group_Typ - 1)];
			_WPTempB = [];_fwp = [];_m = 0;_DAC_GroupCount = 0;_DAC_UnitCount = 0;_DAC_CountMIN = 0;_DAC_CountMAX = 0;_zData = [];
			_countrandom = 0;_max = 0;_HeloArray = [];DAC_Init_Group set [count DAC_Init_Group,_DAC_Group_Typ];_run = 9;_GroupPos = [];_action = true;
			_go = true;_check = 1;_maxrad = 0;_Camp_Pool = [];_groupBehav = [];_DAC_This_Zone = _this select 1;_wpConfNr = 0;_DAC_ExtraUnit = [];
			
if(_DAC_Group_Typ == 1) then
{
	{[_x,_DAC_This_Zone]execVM "DAC\Scripts\DAC_New_Groups.sqf"} foreach _ScriptArray;
	_run = 1;
}
else
{
	...
	switch (_run) do
	{
		...
		case 2:		{
						...
						else
						{
							...
							{
								_DAC_ZoneRadiusX = _DAC_SelectZone select 1;
								_DAC_ZoneRadiusY = _DAC_SelectZone select 2;_DAC_ZoneMode = ((_DAC_SelectZone select 3) select 0);
						...
						while {_check > 0} do
						{
							switch (_check) do
							{
								case 1:	{
											...
											while {_go} do
											{
												...
												else
												{
													...
													{
														_tz = (call compile _wp) select 0;_maxrad = (call compile _wp) select 7;
														if((((call compile _wp) select 1) select 0) == _DAC_ZoneMode) then {_go = false;_check = 2};
													};
											...
											while {_go} do
											{
												...
												else
												{
													...
													else
													{
														...
														{
															_WPTempB set [count _WPTempB,_wp];
														};
													};
												};
											};
								...
								case 5:	{
											...
											if((_max > (count _WPTempA + count _WPTempB)) && (_DAC_CountMAX > 0)) then {_max = count _WPTempA};
											_fwp = _WPTempA select (random ((count _WPTempA) - 1));
		...
		case 4:		{
						...
						{
							case 1:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData],1,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]execVM "DAC\Scripts\DAC_Group_Soldier.sqf";
										[1,[_countrandom,[_GroupWP,_GroupPos,_zData],1,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]]execVM "DAC\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 2:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData],2,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]execVM "DAC\Scripts\DAC_Group_Vehicle.sqf";
										[2,[_countrandom,[_GroupWP,_GroupPos,_zData],2,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]]execVM "DAC\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 3:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData],3,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,_DAC_ExtraUnit,_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]execVM "DAC\Scripts\DAC_Group_Tank.sqf";
										[3,[_countrandom,[_GroupWP,_GroupPos,_zData],3,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,_DAC_ExtraUnit,_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]]execVM "DAC\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 4:	{
										[_countrandom,1,[_GroupWP,_GroupPos,_zData],4,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_DAC_Zone_Set,_wpConfNr]execVM "DAC\Scripts\DAC_Group_Air.sqf";
										[4,[_countrandom,1,[_GroupWP,_GroupPos,_zData],4,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_DAC_Zone_Set,_wpConfNr]]execVM "DAC\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 5:	{
